...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * Clicking on the CIRCLE button will add a rectangle to canvas
         */
    ...
    public ListIterator<Shape> adjustShapesAlpha(){
        ...
        for(int i = 0; i < shapesList.size(); i++){
            if(shapesList.get(i).getAlpha() < 0.2f){
                shapesList.get(i).removeShape();
            }
         //   else{
           //     float newAlpha = shapesList.get(i).getAlpha();
             //   newAlpha = newAlpha - 0.01f;
               // shapesList.get(i).setShapeAlpha(newAlpha);
            //}
    ...
    public void addShape(ShapeType shapeType, View v){
        ...
        switch(shapeType){
            ...
            // TODO:  Your code goes here
            case RECTANGLE:
                newShape = shapeFactory.getShape(context, "RECTANGLE");
                break;
            case CIRCLE:
                newShape = shapeFactory.getShape(context, "CIRCLE");
                break;
            case PICTURE:
                newShape = shapeFactory.getShape(context, "PICTURE");
                break;
            default :
                newShape = null;
        }
